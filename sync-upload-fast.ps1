...
$logFile = Join-Path $logRoot ("robocopy-upload-{0}.log" -f (Get-Date -Format 'yyyyMMdd-HHmmss'))
...
Write-Host "Fast upload source:      $LocalPath"
Write-Host "Fast upload destination: $RemotePath"
