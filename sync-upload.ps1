...
$logFile = Join-Path $logRoot ("rclone-upload-{0}.log" -f (Get-Date -Format 'yyyyMMdd-HHmmss'))
...
Write-Host "Upload source:      $LocalPath"
Write-Host "Upload destination: $RemotePath"
